...
async function main() {
    ...
    let response = await networkAPIModule.createAccount('kelvinfan', 'Kelvin Fan', 'kelvin@sipher.co', 'Personal', 'tkVHnyGmESTV', 'SipherMSP'); //* no need to try/catch because createAccount already handles error
