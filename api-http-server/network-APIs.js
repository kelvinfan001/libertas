 ...
 * @param {string} start state timestamp for campaign 
 * @param {string} end end timestamp for campaign
 * @param {string} username username for the user calling this function
 */
...
async function execute_example() {
    ...
    var start = Date.parse('1970-01-01') / 1000;
    ...
    // Vote:
    // await createVote('personalAccountID', 'campaignID', 'usernameP');
